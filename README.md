...
* `traefik_dashboard` [default: `false`]: If `true`, enables the API and dashboard
...
* `traefik_debug` [default: `false`]: If `true`, traefik will print debug messages
* `traefik_docker_image` [default: `traefik:v3.6`]: Image of the traefik docker image to use
